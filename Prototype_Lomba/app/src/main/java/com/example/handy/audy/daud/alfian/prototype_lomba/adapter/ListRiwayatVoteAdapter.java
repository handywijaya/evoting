...
/**
 * Created by Audy on 9/12/2015
 */
public class ListRiwayatVoteAdapter extends RecyclerView.Adapter<ListRiwayatVoteAdapter.ViewHolder> {

    private final Context context;
    private List<Soal> soal = new ArrayList<>();
    private OnItemClickListener itemClickListener;

    public ListRiwayatVoteAdapter(Context context) {
